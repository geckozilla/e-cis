            ...
            <div class="row">
                <div class="col-sm-6  col-sm-offset-3 col-md-4 col-md-offset-4">
                    <div class="account-wall">
                        ...
                        <?php echo form_open("user/reset_password/" . $code, array('class' => 'form-signin', 'id' => 'formku')); ?>
                        <p>
                        ...
                        <p>
                            <button name="submit" type="submit" id="submit" class="btn btn-lg btn-primary btn-block" >Change</button>
                        </p>
