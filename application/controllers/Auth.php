...
class Auth extends CI_Controller {
    ...
    function sendMail() {
        $config = Array(
            ...
            'smtp_port' => 465,
            'smtp_user' => 'teddcm@gmail.com', // change it to yours
            'smtp_pass' => 'm354313m', // change it to yours
            'mailtype' => 'html',
            'charset' => 'iso-8859-1',
            'wordwrap' => TRUE
        );
        ...
        $this->email->from('teddcm@gmail.com'); // change it to yours
        $this->email->to('teddcm@gmail.com'); // change it to yours
    ...
    public function email() {
        ...
        $this->email->from('teddcm@gmail.com', 'Your Name');
        $this->email->to('teddcm@gmail.com');
        $this->email->cc('teddcm@gmail.com');
        $this->email->bcc('teddcm@gmail.com');
